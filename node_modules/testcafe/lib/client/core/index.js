			...
			"client": {
				"browser": {
					"index.js": function (exports, module, require) {
						...
						exports.getActiveWindowId = getActiveWindowId;
						exports.setActiveWindowId = setActiveWindowId;
						...
						function startHeartbeat(heartbeatUrl, createXHR) {
						    ...
						    heartbeatIntervalId = window.setInterval(heartbeat, _browserConnectionTimeouts.HEARTBEAT_INTERVAL);
				...
				"core": {
					...
					"scroll-controller.js": function (exports, module, require) {
						...
						var ScrollController = function () {
						    ...
						    ScrollController.prototype.waitForScroll = function waitForScroll(scrollElement) {
						        var _this2 = this;
						        ...
						        if (this.initialized) this.handleScrollEvents(scrollElement, promiseResolver);else promiseResolver();

						        return promise;
						    };

						    ScrollController.prototype.handleScrollEvents = function handleScrollEvents(el, handler) {
						        var _this3 = this;

						        this.events.once('scroll', handler);

						        if ((0, _dom.isShadowElement)(el)) {
						            listeners.initElementListening(el, ['scroll']);
						            listeners.addFirstInternalHandler(el, ['scroll'], function () {
						                _this3._internalListener.apply(_this3, arguments);
					...
					"utils": {
						...
						"event.js": function (exports, module, require) {
							...
							function bind(el, event, handler, useCapture) {
							    if (browserUtils.isIE11 && domUtils.isWindow(el)) nativeMethods.windowAddEventListener.call(el, event, handler, useCapture);else nativeMethods.addEventListener.call(el, event, handler, useCapture);
							}

							function unbind(el, event, handler, useCapture) {
							    if (browserUtils.isIE11 && domUtils.isWindow(el)) nativeMethods.windowRemoveEventListener.call(el, event, handler, useCapture);else nativeMethods.removeEventListener.call(el, event, handler, useCapture);
							}
...
})("testcafe/src/client/core/index");
