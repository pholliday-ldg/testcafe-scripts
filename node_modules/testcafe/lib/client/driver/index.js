		...
		"src": {
			"client": {
				...
				"driver": {
					"command-executors": {
						...
						"execute-child-window-driver-link-selector.js": function (exports, module, require) {
							

							exports.__esModule = true;
							exports.default = executeChildWindowDriverLinkSelector;
							...
							function executeChildWindowDriverLinkSelector(selector, childWindowLinks) {
							    if (typeof selector === 'string') {
							        var foundChildWindowDriverLink = _testcafeCore.arrayUtils.find(childWindowLinks, function (link) {
							            return link.windowId === selector;
							        });

							        if (!foundChildWindowDriverLink) {
							            var error = new _testRun.ChildWindowNotFoundError();
						...
						"execute-navigate-to.js": function (exports, module, require) {
							...
							function executeNavigateTo(command) {
							    ...
							    return ensurePagePromise.then(function () {
							        ...
							        _hammerhead2.default.navigateTo(command.url, command.forceReload);
					...
					"driver-link": {
						"iframe": {
							"child.js": function (exports, module, require) {
								...
								var _sendConfirmationMessage2 = require('../send-confirmation-message');

								var _sendConfirmationMessage3 = _interopRequireDefault(_sendConfirmationMessage2);

								function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

								function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

								var ChildIframeDriverLink = function () {
								    function ChildIframeDriverLink(driverWindow, driverId) {
								        _classCallCheck(this, ChildIframeDriverLink);
								    ...
								    ChildIframeDriverLink.prototype._ensureIframe = function _ensureIframe() {
								        var _this = this;
								        ...
								        }, _timeouts.CHECK_IFRAME_VISIBLE_INTERVAL, this.iframeAvailabilityTimeout).catch(function () {
								            throw new _testRun.CurrentIframeIsInvisibleError();
								        });
								    };

								    ChildIframeDriverLink.prototype._waitForIframeRemovedOrHidden = function _waitForIframeRemovedOrHidden() {
								        var _this2 = this;
								        ...
								        return new _hammerhead.Promise(function (resolve) {
								            _this2.checkIframeInterval = _hammerhead.nativeMethods.setInterval.call(window, function () {
								                _this2._ensureIframe().catch(function () {
								                    ...
								                    return (0, _testcafeCore.delay)(_timeouts.WAIT_IFRAME_RESPONSE_DELAY).then(function () {
								                        return resolve(new _status2.default({ isCommandResult: true }));
								                    });
								                });
								            }, _timeouts.CHECK_IFRAME_EXISTENCE_INTERVAL);
								        });
								    };

								    ChildIframeDriverLink.prototype._waitForCommandResult = function _waitForCommandResult() {
								        var _this3 = this;
								    ...
								    ChildIframeDriverLink.prototype.sendConfirmationMessage = function sendConfirmationMessage(requestMsgId) {
								        (0, _sendConfirmationMessage3.default)({
								    ...
								    ChildIframeDriverLink.prototype.executeCommand = function executeCommand(command, testSpeed) {
								        var _this4 = this;
								    ...
								    _createClass(ChildIframeDriverLink, [{
								...
								exports.default = ChildIframeDriverLink;
								module.exports = exports['default'];
							},
							"parent.js": function (exports, module, require) {
								...
								var ParentIframeDriverLink = function () {
								    function ParentIframeDriverLink(parentDriverWindow) {
								        _classCallCheck(this, ParentIframeDriverLink);

								        this.driverWindow = parentDriverWindow;
								    }

								    ParentIframeDriverLink.prototype.establishConnection = function establishConnection() {
								        var msg = new _messages.EstablishConnectionMessage();

								        return (0, _sendMessageToDriver2.default)(msg, this.driverWindow, _timeouts.WAIT_FOR_WINDOW_DRIVER_RESPONSE_TIMEOUT, _testRun.CurrentIframeIsNotLoadedError).then(function (response) {
								            return response.result.id;
								        });
								    };

								    ParentIframeDriverLink.prototype.sendConfirmationMessage = function sendConfirmationMessage(requestMsgId) {
								        (0, _sendConfirmationMessage3.default)({
								            requestMsgId: requestMsgId,
								            window: this.driverWindow
								        });
								    ...
								    ParentIframeDriverLink.prototype.onCommandExecuted = function onCommandExecuted(status) {
								...
								exports.default = ParentIframeDriverLink;
								module.exports = exports['default'];
							}
						},
						"messages.js": function (exports, module, require) {
							...
							exports.__esModule = true;
							exports.CloseAllChildWindowsMessage = exports.SetAsMasterMessage = exports.SetNativeDialogHandlerMessage = exports.ConfirmationMessage = exports.ExecuteCommandMessage = exports.CommandExecutedMessage = exports.EstablishConnectionMessage = exports.TYPE = undefined;
							...
							var SetAsMasterMessage = exports.SetAsMasterMessage = function (_InterDriverMessage6) {
							    _inherits(SetAsMasterMessage, _InterDriverMessage6);

							    function SetAsMasterMessage() {
							        _classCallCheck(this, SetAsMasterMessage);

							        return _possibleConstructorReturn(this, _InterDriverMessage6.call(this, TYPE.setAsMaster));
							    }

							    return SetAsMasterMessage;
							}(InterDriverMessage);

							var CloseAllChildWindowsMessage = exports.CloseAllChildWindowsMessage = function (_InterDriverMessage7) {
							    _inherits(CloseAllChildWindowsMessage, _InterDriverMessage7);

							    function CloseAllChildWindowsMessage() {
							        _classCallCheck(this, CloseAllChildWindowsMessage);

							        return _possibleConstructorReturn(this, _InterDriverMessage7.call(this, TYPE.closeAllChildWindows));
							    }

							    return CloseAllChildWindowsMessage;
							}(InterDriverMessage);
						},
						"send-confirmation-message.js": function (exports, module, require) {
							

							exports.__esModule = true;

							exports.default = function (_ref) {
							    var requestMsgId = _ref.requestMsgId,
							        result = _ref.result,
							        window = _ref.window;

							    var msg = new _messages.ConfirmationMessage(requestMsgId, result);

							    _hammerhead.eventSandbox.message.sendServiceMsg(msg, window);
							};
						...
						"timeouts.js": function (exports, module, require) {
							

							exports.__esModule = true;
							var WAIT_FOR_WINDOW_DRIVER_RESPONSE_TIMEOUT = exports.WAIT_FOR_WINDOW_DRIVER_RESPONSE_TIMEOUT = 5000;
							var CHECK_IFRAME_EXISTENCE_INTERVAL = exports.CHECK_IFRAME_EXISTENCE_INTERVAL = 1000;
							var CHECK_IFRAME_VISIBLE_INTERVAL = exports.CHECK_IFRAME_VISIBLE_INTERVAL = 200;
							var WAIT_IFRAME_RESPONSE_DELAY = exports.WAIT_IFRAME_RESPONSE_DELAY = 500;
							var CHECK_CHILD_WINDOW_CLOSED_INTERVAL = exports.CHECK_CHILD_WINDOW_CLOSED_INTERVAL = 200;
						},
						"window": {
							"child.js": function (exports, module, require) {
								...
								var ChildWindowDriverLink = function () {
								    function ChildWindowDriverLink(driverWindow, windowId) {
								        _classCallCheck(this, ChildWindowDriverLink);

								        this.driverWindow = driverWindow;
								        this.windowId = windowId;
								    }

								    ChildWindowDriverLink.prototype.setAsMaster = function setAsMaster() {
								        var msg = new _messages.SetAsMasterMessage();

								        return (0, _sendMessageToDriver2.default)(msg, this.driverWindow, _timeouts.WAIT_FOR_WINDOW_DRIVER_RESPONSE_TIMEOUT, _testRun.CannotSwitchToWindowError);
								    };

								    ChildWindowDriverLink.prototype.closeAllChildWindows = function closeAllChildWindows() {
								        var msg = new _messages.CloseAllChildWindowsMessage();

								        return (0, _sendMessageToDriver2.default)(msg, this.driverWindow, _timeouts.WAIT_FOR_WINDOW_DRIVER_RESPONSE_TIMEOUT, _testRun.CloseChildWindowError);
								    };

								    return ChildWindowDriverLink;
								}();

								exports.default = ChildWindowDriverLink;
								module.exports = exports['default'];
							},
							"parent.js": function (exports, module, require) {
								...
								var ParentWindowDriverLink = function () {
								    function ParentWindowDriverLink(currentDriverWindow) {
								        _classCallCheck(this, ParentWindowDriverLink);

								        this.currentDriverWindow = currentDriverWindow;
								    }

								    ParentWindowDriverLink.prototype._getTopOpenedWindow = function _getTopOpenedWindow(wnd) {
								        var topOpened = wnd;
								    ...
								    ParentWindowDriverLink.prototype._setAsMaster = function _setAsMaster(wnd) {
								        var msg = new _messages.SetAsMasterMessage();

								        return (0, _sendMessageToDriver2.default)(msg, wnd, _timeouts.WAIT_FOR_WINDOW_DRIVER_RESPONSE_TIMEOUT, _testRun.CannotSwitchToWindowError);
								    };

								    ParentWindowDriverLink.prototype.setTopOpenedWindowAsMaster = function setTopOpenedWindowAsMaster() {
								        var wnd = this._getTopOpenedWindow(this.currentDriverWindow);

								        return this._setAsMaster(wnd);
								    };

								    ParentWindowDriverLink.prototype.setParentWindowAsMaster = function setParentWindowAsMaster() {
								...
								exports.default = ParentWindowDriverLink;
								module.exports = exports['default'];
							}
						}
					},
					"driver.js": function (exports, module, require) {
						...
						var _child = require('./driver-link/iframe/child');
						...
						var _executeChildWindowDriverLinkSelector = require('./command-executors/execute-child-window-driver-link-selector');

						var _executeChildWindowDriverLinkSelector2 = _interopRequireDefault(_executeChildWindowDriverLinkSelector);

						var _clientFunctionExecutor = require('./command-executors/client-functions/client-function-executor');

						var _clientFunctionExecutor2 = _interopRequireDefault(_clientFunctionExecutor);

						var _child3 = require('./driver-link/window/child');

						var _child4 = _interopRequireDefault(_child3);

						var _parent = require('./driver-link/window/parent');

						var _parent2 = _interopRequireDefault(_parent);

						var _sendConfirmationMessage = require('./driver-link/send-confirmation-message');

						var _sendConfirmationMessage2 = _interopRequireDefault(_sendConfirmationMessage);

						var _cursor = require('../automation/cursor');
						...
						var _timeouts = require('./driver-link/timeouts');
						...
						var Driver = function (_serviceUtils$EventEm) {
						    _inherits(Driver, _serviceUtils$EventEm);
						    ...
						    function Driver(testRunId, communicationUrls, runInfo, options) {
						        ...
						        _this.role = _role2.default.replica;
						        ...
						        _this.pageInitialRequestBarrier = new _testcafeCore.RequestBarrier();

						        _this.readyPromise = _testcafeCore.eventUtils.documentReady(_this.pageLoadTimeout).then(function () {
						        ...
						        _hammerhead2.default.on(_hammerhead2.default.EVENTS.beforeFormSubmit, function (e) {
						            return _this._onFormSubmit(e);
						        });
						        _hammerhead2.default.on(_hammerhead2.default.EVENTS.windowOpened, function (e) {
						            return _this._onChildWindowOpened(e);
						        });

						        _this.setCustomCommandHandlers(_type2.default.unlockPage, function () {
						            return _this._unlockPageAfterTestIsDone();
						        });
						        return _this;
						    }

						    Driver.prototype._hasPendingActionFlags = function _hasPendingActionFlags(contextStorage) {
						        return contextStorage.getItem(this.COMMAND_EXECUTING_FLAG) || contextStorage.getItem(this.EXECUTING_IN_IFRAME_FLAG);
						    };

						    Driver.prototype._getCurrentWindowId = function _getCurrentWindowId() {
						        var currentUrl = window.location.toString();
						        var parsedProxyUrl = _hammerhead2.default.utils.url.parseProxyUrl(currentUrl);
						    ...
						    Driver.prototype.onCustomClientScriptError = function onCustomClientScriptError(err, moduleName) {
						        var error = moduleName ? new _testRun.UncaughtErrorInCustomClientScriptLoadedFromModule(err, moduleName) : new _testRun.UncaughtErrorInCustomClientScriptCode(err);

						        if (!this.contextStorage.getItem(PENDING_PAGE_ERROR)) this.contextStorage.setItem(PENDING_PAGE_ERROR, error);
						    };

						    Driver.prototype._addChildWindowDriverLink = function _addChildWindowDriverLink(e) {
						        var childWindowDriverLink = new _child4.default(e.window, e.windowId);

						        this.childWindowDriverLinks.push(childWindowDriverLink);
						        this._ensureClosedChildWindowWatcher();
						    };

						    Driver.prototype._ensureClosedChildWindowWatcher = function _ensureClosedChildWindowWatcher() {
						        var _this2 = this;

						        if (this.checkClosedChildWindowIntervalId) return;

						        this.checkClosedChildWindowIntervalId = nativeMethods.setInterval.call(window, function () {
						            var firstClosedChildWindowDriverLink = _testcafeCore.arrayUtils.find(_this2.childWindowDriverLinks, function (childWindowDriverLink) {
						                return childWindowDriverLink.driverWindow.closed;
						            });

						            if (!firstClosedChildWindowDriverLink) return;

						            _testcafeCore.arrayUtils.remove(_this2.childWindowDriverLinks, firstClosedChildWindowDriverLink);
						            _this2._setCurrentWindowAsMaster();

						            if (!_this2.childWindowDriverLinks.length) nativeMethods.clearInterval.call(window, _this2.checkClosedChildWindowIntervalId);
						        }, _timeouts.CHECK_CHILD_WINDOW_CLOSED_INTERVAL);
						    };

						    Driver.prototype._setAsMasterInProgressOrCompleted = function _setAsMasterInProgressOrCompleted() {
						        return this.setAsMasterInProgress || this.role === _role2.default.master;
						    };

						    Driver.prototype._setCurrentWindowAsMaster = function _setCurrentWindowAsMaster() {
						        var _this3 = this;

						        if (this._setAsMasterInProgressOrCompleted()) return;

						        this.setAsMasterInProgress = true;

						        Promise.resolve().then(function () {
						            return _testcafeCore.browser.setActiveWindowId(_this3.browserActiveWindowId, _hammerhead2.default.createNativeXHR, _this3.windowId);
						        }).then(function () {
						            _this3._startInternal({ finalizePendingCommand: true });

						            _this3.setAsMasterInProgress = false;
						        }).catch(function () {
						            _this3._onReady(new _status2.default({
						                isCommandResult: true,
						                executionError: new _testRun.CannotSwitchToWindowError()
						            }));
						        });
						    };

						    Driver.prototype._onChildWindowOpened = function _onChildWindowOpened(e) {
						    ...
						    Driver.prototype._onFormSubmit = function _onFormSubmit(e) {
						        ...
						        if (this.contextStorage && this.contextStorage.getItem(TEST_DONE_SENT_FLAG)) e.preventSubmit = true;
						    };
						    ...
						    Driver.prototype._addPendingWindowSwitchingStateToStatus = function _addPendingWindowSwitchingStateToStatus(status) {
						    ...
						    Driver.prototype._sendStatusRequest = function _sendStatusRequest(status) {
						        ...
						        var requestAttempt = function requestAttempt() {
						            return (0, _testcafeCore.getTimeLimitedPromise)(transport.asyncServiceMsg(statusRequestOptions), _browserConnectionTimeouts.SEND_STATUS_REQUEST_TIME_LIMIT);
						        };
						        var retryRequest = function retryRequest() {
						            return (0, _testcafeCore.delay)(_browserConnectionTimeouts.SEND_STATUS_REQUEST_RETRY_DELAY).then(requestAttempt);
						        };

						        var statusPromise = requestAttempt();

						        for (var i = 0; i < _browserConnectionTimeouts.SEND_STATUS_REQUEST_RETRY_COUNT; i++) {
						    ...
						    Driver.prototype._sendStatus = function _sendStatus(status) {
						        ...
						        return _testcafeCore.pageUnloadBarrier.wait(0).then(function () {
						            return _this4._sendStatusRequest(status);
						        })
						        ...
						        .then(function (res) {
						            ...
						            _this4.contextStorage.setItem(PENDING_STATUS, null);
						    ...
						    Driver.prototype._addChildIframeDriverLink = function _addChildIframeDriverLink(id, driverWindow) {
						        var childIframeDriverLink = this._getChildIframeDriverLinkByWindow(driverWindow);

						        if (!childIframeDriverLink) {
						            var driverId = this.testRunId + '-' + (0, _generateId2.default)();

						            childIframeDriverLink = new _child2.default(driverWindow, driverId);
						    ...
						    Driver.prototype._handleSetAsMasterMessage = function _handleSetAsMasterMessage(msg, wnd) {
						        var _this5 = this;
						        ...
						        (0, _sendConfirmationMessage2.default)({
						            requestMsgId: msg.id,
						            window: wnd
						        });

						        Promise.resolve().then(function () {
						            return _testcafeCore.browser.setActiveWindowId(_this5.browserActiveWindowId, _hammerhead2.default.createNativeXHR, _this5.windowId);
						        }).then(function () {
						            _this5._startInternal();

						            _this5.setAsMasterMessageReceived = false;
						        }).catch(function () {
						            _this5._onReady(new _status2.default({
						                isCommandResult: true,
						                executionError: new _testRun.CannotSwitchToWindowError()
						            }));
						        });
						    ...
						    Driver.prototype._handleCloseAllWindowsMessage = function _handleCloseAllWindowsMessage(msg, wnd) {
						        var _this6 = this;

						        this._closeAllChildWindows().then(function () {
						            (0, _sendConfirmationMessage2.default)({
						                requestMsgId: msg.id,
						                window: wnd
						            });
						        }).catch(function () {
						            _this6._onReady(new _status2.default({
						                isCommandResult: true,
						                executionError: new _testRun.CloseChildWindowError()
						            }));
						        });
						    };
						    ...
						    Driver.prototype._initChildDriverListening = function _initChildDriverListening() {
						        ...
						        messageSandbox.on(messageSandbox.SERVICE_MSG_RECEIVED_EVENT, function (e) {
						            ...
						            if (msg.type === _messages.TYPE.establishConnection) _this7._addChildIframeDriverLink(msg.id, window);else if (msg.type === _messages.TYPE.setAsMaster) _this7._handleSetAsMasterMessage(msg, window);else if (msg.type === _messages.TYPE.closeAllChildWindows) _this7._handleCloseAllWindowsMessage(msg, window);
						        });
						    };

						    Driver.prototype._getChildIframeDriverLinkByWindow = function _getChildIframeDriverLinkByWindow(driverWindow) {
						        return _testcafeCore.arrayUtils.find(this.childIframeDriverLinks, function (link) {
						            return link.driverWindow === driverWindow;
						        });
						    };

						    Driver.prototype._getChildWindowDriverLinkByWindow = function _getChildWindowDriverLinkByWindow(childDriverWindow) {
						        return _testcafeCore.arrayUtils.find(this.childWindowDriverLinks, function (link) {
						            return link.driverWindow === childDriverWindow;
						        });
						    };
						    ...
						    Driver.prototype._runInActiveIframe = function _runInActiveIframe(command) {
						        ...
						        if (!this.activeChildIframeDriverLink && activeIframeSelector) runningChain = this._switchToIframe(activeIframeSelector, CURRENT_IFRAME_ERROR_CTORS);

						        runningChain.then(function () {
						            _this8.contextStorage.setItem(_this8.EXECUTING_IN_IFRAME_FLAG, true);

						            return _this8.activeChildIframeDriverLink.executeCommand(command, _this8.speed);
						        }).then(function (status) {
						            return _this8._onCommandExecutedInIframe(status);
						        }).catch(function (err) {
						            return _this8._onCommandExecutedInIframe(new _status2.default({
						                isCommandResult: true,
						                executionError: err
						            }));
						        });
						    ...
						    Driver.prototype._ensureChildIframeDriverLink = function _ensureChildIframeDriverLink(iframeWindow, ErrorCtor, selectorTimeout) {
						        var _this9 = this;
						        ...
						        return (0, _testcafeCore.waitFor)(function () {
						            return _this9._getChildIframeDriverLinkByWindow(iframeWindow);
						        }, _browserConnectionTimeouts.CHECK_IFRAME_DRIVER_LINK_DELAY, selectorTimeout).catch(function () {
						            throw new ErrorCtor();
						        });
						    };

						    Driver.prototype._ensureChildWindowDriverLink = function _ensureChildWindowDriverLink(childWindow, ErrorCtor, timeout) {
						        var _this10 = this;
						        ...
						        return (0, _testcafeCore.waitFor)(function () {
						            return _this10._getChildWindowDriverLinkByWindow(childWindow);
						        }, _browserConnectionTimeouts.CHECK_CHILD_WINDOW_DRIVER_LINK_DELAY, timeout).catch(function () {
						            throw new ErrorCtor();
						        });
						    };
						    ...
						    Driver.prototype._switchToIframe = function _switchToIframe(selector, iframeErrorCtors) {
						        ...
						        return (0, _executeSelector.getResult)(selector, commandSelectorTimeout, null, function (fn) {
						            ...
						            return new iframeErrorCtors.IsInvisibleError();
						            ...
						            return _this11._ensureChildIframeDriverLink(nativeMethods.contentWindowGetter.call(iframe), iframeErrorCtors.NotLoadedError, commandSelectorTimeout);
						        }).then(function (childDriverLink) {
						            childDriverLink.availabilityTimeout = commandSelectorTimeout;
						            _this11.activeChildIframeDriverLink = childDriverLink;
						            _this11.contextStorage.setItem(ACTIVE_IFRAME_SELECTOR, selector);
						        });
						    };

						    Driver.prototype._createWaitForEventPromise = function _createWaitForEventPromise(eventName, timeout) {
						        var _this12 = this;
						        ...
						        var timeoutPromise = new Promise(function (resolve) {
						            nativeMethods.setTimeout.call(window, function () {
						                _this12.off(eventName, _eventHandler);
						        ...
						        var resultPromise = new Promise(function (resolve) {
						            _eventHandler = function eventHandler() {
						                this.off(eventName, _eventHandler);

						                resolve();
						            };

						            _this12.on(eventName, _eventHandler);
						        });

						        return Promise.race([timeoutPromise, resultPromise]);
						    };

						    Driver.prototype._waitForCurrentCommandCompletion = function _waitForCurrentCommandCompletion() {
						        if (!this.contextStorage.getItem(this.COMMAND_EXECUTING_FLAG)) return Promise.resolve();

						        return this._createWaitForEventPromise(STATUS_WITH_COMMAND_RESULT_EVENT, COMMAND_EXECUTION_MAX_TIMEOUT);
						    };

						    Driver.prototype._waitForEmptyCommand = function _waitForEmptyCommand() {
						        return this._createWaitForEventPromise(EMPTY_COMMAND_EVENT, EMPTY_COMMAND_EVENT_WAIT_TIMEOUT);
						    };

						    Driver.prototype._switchToChildWindow = function _switchToChildWindow(selector) {
						        var _this13 = this;

						        this.contextStorage.setItem(this.PENDING_WINDOW_SWITCHING_FLAG, true);

						        return (0, _executeChildWindowDriverLinkSelector2.default)(selector, this.childWindowDriverLinks).then(function (childWindowDriverLink) {
						            return _this13._ensureChildWindowDriverLink(childWindowDriverLink.driverWindow, _testRun.ChildWindowIsNotLoadedError, _this13.childWindowReadyTimeout);
						        }).then(function (childWindowDriverLink) {
						            _this13.activeChildWindowDriverLink = childWindowDriverLink;

						            return _this13._waitForCurrentCommandCompletion();
						        }).then(function () {
						            return _this13._waitForEmptyCommand();
						        }).then(function () {
						            _this13._stopInternal();

						            return _this13.activeChildWindowDriverLink.setAsMaster();
						        }).then(function () {
						            _this13.contextStorage.setItem(_this13.PENDING_WINDOW_SWITCHING_FLAG, false);
						        }).catch(function () {
						            _this13.contextStorage.setItem(_this13.PENDING_WINDOW_SWITCHING_FLAG, false);

						            _this13._onReady(new _status2.default({
						                isCommandResult: true,
						                executionError: new _testRun.CannotSwitchToWindowError()
						            }));
						        });
						    ...
						    Driver.prototype._switchToTopParentWindow = function _switchToTopParentWindow() {
						    ...
						    Driver.prototype._switchToParentWindow = function _switchToParentWindow() {
						        var switchFn = this.parentWindowDriverLink.setParentWindowAsMaster.bind(this.parentWindowDriverLink);

						        this._switchToParentWindowInternal(switchFn);
						    };

						    Driver.prototype._switchToParentWindowInternal = function _switchToParentWindowInternal(parentWindowSwitchFn) {
						        var _this14 = this;

						        this.contextStorage.setItem(this.PENDING_WINDOW_SWITCHING_FLAG, true);

						        return Promise.resolve().then(function () {
						            _this14._stopInternal();

						            return parentWindowSwitchFn();
						        }).then(function () {
						            _this14.contextStorage.setItem(_this14.PENDING_WINDOW_SWITCHING_FLAG, false);
						        }).catch(function () {
						            _this14.contextStorage.setItem(_this14.PENDING_WINDOW_SWITCHING_FLAG, false);

						            _this14._onReady(new _status2.default({
						                isCommandResult: true,
						                executionError: new _testRun.CannotSwitchToWindowError()
						            }));
						        });
						    ...
						    Driver.prototype._switchToMainWindow = function _switchToMainWindow(command) {
						        if (this.activeChildIframeDriverLink) this.activeChildIframeDriverLink.executeCommand(command);
						    ...
						    Driver.prototype._onActionCommand = function _onActionCommand(command) {
						        ...
						        startPromise.then(function () {
						            return _this15.contextStorage.setItem(_this15.COMMAND_EXECUTING_FLAG, true);
						        });

						        completionPromise.then(function (driverStatus) {
						            _this15.contextStorage.setItem(_this15.COMMAND_EXECUTING_FLAG, false);

						            return _this15._onReady(driverStatus);
						        });
						    };
						    ...
						    Driver.prototype._onNavigateToCommand = function _onNavigateToCommand(command) {
						        ...
						        (0, _executeNavigateTo2.default)(command).then(function (driverStatus) {
						            _this16.contextStorage.setItem(_this16.COMMAND_EXECUTING_FLAG, false);

						            return _this16._onReady(driverStatus);
						        });
						    };
						    ...
						    Driver.prototype._onExecuteClientFunctionCommand = function _onExecuteClientFunctionCommand(command) {
						        ...
						        executor.getResultDriverStatus().then(function (driverStatus) {
						            _this17.contextStorage.setItem(EXECUTING_CLIENT_FUNCTION_DESCRIPTOR, null);
						            _this17._onReady(driverStatus);
						        });
						    };
						    ...
						    Driver.prototype._onExecuteSelectorCommand = function _onExecuteSelectorCommand(command) {
						        ...
						        (0, _executeSelector.getResultDriverStatus)(command, this.selectorTimeout, startTime, createError, createError, this.statusBar).then(function (driverStatus) {
						            _this18.contextStorage.setItem(SELECTOR_EXECUTION_START_TIME, null);
						            _this18._onReady(driverStatus);
						        });
						    };
						    ...
						    Driver.prototype._onSwitchToIframeCommand = function _onSwitchToIframeCommand(command) {
						        ...
						        this._switchToIframe(command.selector, ACTION_IFRAME_ERROR_CTORS).then(function () {
						            return _this19._onReady(new _status2.default({ isCommandResult: true }));
						        }).catch(function (err) {
						            return _this19._onReady(new _status2.default({
						                isCommandResult: true,
						                executionError: err
						            }));
						        });
						    ...
						    Driver.prototype._onBrowserManipulationCommand = function _onBrowserManipulationCommand(command) {
						        ...
						        (0, _browserManipulation2.default)(command, this.selectorTimeout, this.statusBar).then(function (driverStatus) {
						            _this20.contextStorage.setItem(_this20.COMMAND_EXECUTING_FLAG, false);
						            return _this20._onReady(driverStatus);
						        });
						    };
						    ...
						    Driver.prototype._onSetBreakpointCommand = function _onSetBreakpointCommand(isTestError) {
						        ...
						        this.statusBar.showDebuggingStatus(isTestError).then(function (stopAfterNextAction) {
						            return _this21._onReady(new _status2.default({
						                isCommandResult: true,
						    ...
						    Driver.prototype._onHideAssertionRetriesStatusCommand = function _onHideAssertionRetriesStatusCommand(command) {
						        ...
						        this.statusBar.hideWaitingAssertionRetriesStatus(command.success).then(function () {
						            return _this22._onReady(new _status2.default({ isCommandResult: true }));
						        });
						    };
						    ...
						    Driver.prototype._checkStatus = function _checkStatus() {
						        ...
						        return _testcafeCore.browser.checkStatus(this.browserStatusDoneUrl, _hammerhead2.default.createNativeXHR, { manualRedirect: true }).then(function (_ref2) {
						            ...
						            var isSessionChange = redirecting && command.url.indexOf(_this23.testRunId) < 0;

						            if (isSessionChange) {
						                storages.clear();
						                storages.lock();
						            } else _this23.contextStorage.setItem(TEST_DONE_SENT_FLAG, false);

						            if (redirecting) _testcafeCore.browser.redirect(command);else _this23._onReady({ isCommandResult: false });
						        }).catch(function () {
						            return (0, _testcafeCore.delay)(_browserConnectionTimeouts.CHECK_STATUS_RETRY_DELAY);
						        });
						    };
						    ...
						    Driver.prototype._onCustomCommand = function _onCustomCommand(command) {
						        ...
						        handler(command).then(function (result) {
						            _this24._onReady(new _status2.default({ isCommandResult: true, result: result }));
						        });
						    };

						    Driver.prototype._closeAllChildWindows = function _closeAllChildWindows() {
						        var _this25 = this;

						        if (!this.childWindowDriverLinks.length) return Promise.resolve();

						        return Promise.all(this.childWindowDriverLinks.map(function (childWindowDriverLink) {
						            return childWindowDriverLink.closeAllChildWindows();
						        })).then(function () {
						            nativeMethods.arrayForEach.call(_this25.childWindowDriverLinks, function (childWindowDriverLink) {
						    ...
						    Driver.prototype._onTestDone = function _onTestDone(status) {
						        ...
						        if (this.parentWindowDriverLink) this._switchToTopParentWindow();else {
						            this._closeAllChildWindows().then(function () {
						                return _this26._sendStatus(status);
						            }).then(function () {
						                _this26._checkStatus();
						            }).catch(function () {
						                _this26._onReady(new _status2.default({
						                    isCommandResult: true,
						                    executionError: _testRun.CloseChildWindowError
						                }));
						            });
						        }
						    };
						    ...
						    Driver.prototype._isStatusWithCommandResultInPendingWindowSwitchingMode = function _isStatusWithCommandResultInPendingWindowSwitchingMode(status) {
						        return status.isCommandResult && !!this.contextStorage.getItem(this.PENDING_WINDOW_SWITCHING_FLAG);
						    };

						    Driver.prototype._isEmptyCommandInPendingWindowSwitchingMode = function _isEmptyCommandInPendingWindowSwitchingMode(command) {
						    ...
						    Driver.prototype._onReady = function _onReady(status) {
						        ...
						        if (this._isStatusWithCommandResultInPendingWindowSwitchingMode(status)) this.emit(STATUS_WITH_COMMAND_RESULT_EVENT);

						        this._sendStatus(status).then(function (command) {
						            if (command) _this27._onCommand(command);else {
						                if (_this27._isEmptyCommandInPendingWindowSwitchingMode(command)) {
						                    _this27.emit(EMPTY_COMMAND_EVENT);

						                    return;
						                }

						                // NOTE: the driver gets an empty response if TestRun doesn't get a new command within 2 minutes
						                _this27._onReady(new _status2.default());
						            }
						        });
						    };
						    ...
						    Driver.prototype._onCommand = function _onCommand(command) {
						        ...
						        this.readyPromise.then(function () {
						            ...
						            var pendingPageError = _this28.contextStorage.getItem(PENDING_PAGE_ERROR);

						            if (pendingPageError && isCommandRejectableByError) {
						                _this28._onReady(new _status2.default({ isCommandResult: true }));
						                return;
						            }
						            ...
						            var isThereActiveIframe = _this28.activeChildIframeDriverLink || _this28.contextStorage.getItem(ACTIVE_IFRAME_SELECTOR);

						            if (!_this28._isExecutableInTopWindowOnly(command) && isThereActiveIframe) {
						                _this28._runInActiveIframe(command);
						                return;
						            }

						            _this28._executeCommand(command);
						        });
						    };
						    ...
						    Driver.prototype._startInternal = function _startInternal() {
						        var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { finalizePendingCommand: false };

						        this.role = _role2.default.master;
						    ...
						    Driver.prototype._stopInternal = function _stopInternal() {
						        this.role = _role2.default.replica;

						        _testcafeCore.browser.stopHeartbeat();
						        _cursor2.default.hide();
						    };

						    Driver.prototype._setupAssertionRetryIndication = function _setupAssertionRetryIndication() {
						        var _this29 = this;

						        this.readyPromise.then(function () {
						            _this29.statusBar.hidePageLoadingStatus();

						            var assertionRetriesTimeout = _this29.contextStorage.getItem(ASSERTION_RETRIES_TIMEOUT);

						            if (assertionRetriesTimeout) {
						                var startTime = _this29.contextStorage.getItem(ASSERTION_RETRIES_START_TIME);
						                var timeLeft = assertionRetriesTimeout - (new Date() - startTime);

						                if (timeLeft > 0) _this29.statusBar.showWaitingAssertionRetriesStatus(assertionRetriesTimeout, startTime);
						            }
						        });
						    };

						    Driver.prototype._startCommandsProcessing = function _startCommandsProcessing(finalizePendingCommand) {
						        ...
						        var status = pendingStatus || new _status2.default({ isCommandResult: finalizePendingCommand });
						    ...
						    Driver.prototype._initParentWindowLink = function _initParentWindowLink() {
						        if (window.opener) this.parentWindowDriverLink = new _parent2.default(window);
						    };

						    Driver.prototype._initConsoleMessages = function _initConsoleMessages() {
						        var messages = this.consoleMessages;
						    ...
						    Driver.prototype._getDriverRole = function _getDriverRole() {
						        var _this30 = this;

						        if (!this.windowId) return Promise.resolve(_role2.default.master);

						        return _testcafeCore.browser.getActiveWindowId(this.browserActiveWindowId, _hammerhead2.default.createNativeXHR).then(function (_ref3) {
						            var activeWindowId = _ref3.activeWindowId;

						            return activeWindowId === _this30.windowId ? _role2.default.master : _role2.default.replica;
						        });
						    };

						    Driver.prototype._init = function _init() {
						        this.contextStorage = new _storage2.default(window, this.testRunId, this.windowId);
						        this.nativeDialogsTracker = new _nativeDialogTracker2.default(this.contextStorage, this.dialogHandler);
						        this.statusBar = new _testcafeUi.StatusBar(this.userAgent, this.fixtureName, this.testName, this.contextStorage);
						    ...
						    Driver.prototype.start = function start() {
						        ...
						        this._getDriverRole().then(function (role) {
						            if (role === _role2.default.master) _this31._startInternal();else _this31._initParentWindowLink();
						        });
						    };
					...
					"generate-id.js": function (exports, module, require) {
						...
						exports.default = function () {
						    return _hammerhead.nativeMethods.performanceNow().toString();
						};
					...
					"iframe-driver.js": function (exports, module, require) {
						...
						var _parent = require('./driver-link/iframe/parent');
						...
						var IframeDriver = function (_Driver) {
						            ...
						            _testcafeCore.pageUnloadBarrier.wait(0).then(function () {
						                ...
						                if (msg.type === _messages.TYPE.executeCommand) {
						                    ...
						                    _this2.readyPromise.then(function () {
						                        ...
						                        _this2.parentDriverLink.sendConfirmationMessage(msg.id);
						    ...
						    IframeDriver.prototype.start = function start() {
						        ...
						        var initializePromise = this.parentDriverLink.establishConnection().then(function (id) {
						            _this3.contextStorage = new _storage2.default(window, id, _this3.windowId);
					...
					"index.js": function (exports, module, require) {
						...
						var _internalProperties = require('./internal-properties');
						...
						nativeMethods.objectDefineProperty(window, _internalProperties2.default.testCafeDriver, { configurable: true, value: _driver2.default });
						nativeMethods.objectDefineProperty(window, _internalProperties2.default.testCafeIframeDriver, { configurable: true, value: _iframeDriver2.default });
						nativeMethods.objectDefineProperty(window, _internalProperties2.default.scriptExecutionBarrier, {
						    configurable: true,
						    value: _scriptExecutionBarrier2.default
						});
						nativeMethods.objectDefineProperty(window, _internalProperties2.default.testCafeEmbeddingUtils, { configurable: true, value: _embeddingUtils2.default });
					...
					"role.js": function (exports, module, require) {
					...
					"status.js": function (exports, module, require) {
						...
						var DriverStatus = function (_Assignable) {
						    ...
						    DriverStatus.prototype._getAssignableProperties = function _getAssignableProperties() {
						        return [{ name: 'isCommandResult' }, { name: 'executionError' }, { name: 'pageError' }, { name: 'result' }, { name: 'consoleMessages' }, { name: 'isPendingWindowSwitching' }];
						    };
					...
					"storage.js": function (exports, module, require) {
						...
						var Storage = function () {
						    ...
						    Storage.prototype._createStorageKey = function _createStorageKey(testRunId, windowId) {
						        var storageKey = STORAGE_KEY_PREFIX + testRunId;

						        if (windowId) return storageKey + '|' + windowId;
			...
			"errors": {
				"test-run": {
					"index.js": function (exports, module, require) {
						...
						var UncaughtErrorInCustomScript = exports.UncaughtErrorInCustomScript = function (_TestRunErrorBase35) {
						    _inherits(UncaughtErrorInCustomScript, _TestRunErrorBase35);

						    function UncaughtErrorInCustomScript(err, expression, line, column, callsite) {
						        _classCallCheck(this, UncaughtErrorInCustomScript);

						        var _this53 = _possibleConstructorReturn(this, _TestRunErrorBase35.call(this, _types.TEST_RUN_ERRORS.uncaughtErrorInCustomScript));
						        ...
						        _this53.originError = err;
						        _this53.errMsg = err.message || String(err);
						        return _this53;
						    }
						...
						var UncaughtTestCafeErrorInCustomScript = exports.UncaughtTestCafeErrorInCustomScript = function (_TestRunErrorBase36) {
						    _inherits(UncaughtTestCafeErrorInCustomScript, _TestRunErrorBase36);

						    function UncaughtTestCafeErrorInCustomScript(err, expression, line, column, callsite) {
						        _classCallCheck(this, UncaughtTestCafeErrorInCustomScript);

						        var _this54 = _possibleConstructorReturn(this, _TestRunErrorBase36.call(this, _types.TEST_RUN_ERRORS.uncaughtTestCafeErrorInCustomScript));

						        _this54.callsite = callsite;
						        _this54.expression = expression;
						        _this54.line = line;
						        _this54.column = column;

						        _this54.originError = err;
						        _this54.errCallsite = err.callsite;
						        return _this54;
						    }
						...
						var WindowDimensionsOverflowError = exports.WindowDimensionsOverflowError = function (_TestRunErrorBase37) {
						    _inherits(WindowDimensionsOverflowError, _TestRunErrorBase37);

						    function WindowDimensionsOverflowError(callsite) {
						        _classCallCheck(this, WindowDimensionsOverflowError);

						        var _this55 = _possibleConstructorReturn(this, _TestRunErrorBase37.call(this, _types.TEST_RUN_ERRORS.windowDimensionsOverflowError));

						        _this55.callsite = callsite;
						        return _this55;
						    }
						...
						var InvalidElementScreenshotDimensionsError = exports.InvalidElementScreenshotDimensionsError = function (_TestRunErrorBase38) {
						    _inherits(InvalidElementScreenshotDimensionsError, _TestRunErrorBase38);
						    ...
						    function InvalidElementScreenshotDimensionsError(width, height) {
						        ...
						        var _this56 = _possibleConstructorReturn(this, _TestRunErrorBase38.call(this, _types.TEST_RUN_ERRORS.invalidElementScreenshotDimensionsError));
						        ...
						        if (widthIsInvalid) {
						            if (heightIsInvalid) {
						                _this56.verb = 'are';
						                _this56.dimensions = 'width and height';
						            } else {
						                _this56.verb = 'is';
						                _this56.dimensions = 'width';
						            }
						        } else {
						            _this56.verb = 'is';
						            _this56.dimensions = 'height';
						        }
						        return _this56;
						    }
						...
						var ForbiddenCharactersInScreenshotPathError = exports.ForbiddenCharactersInScreenshotPathError = function (_TestRunErrorBase39) {
						    _inherits(ForbiddenCharactersInScreenshotPathError, _TestRunErrorBase39);
						    ...
						    function ForbiddenCharactersInScreenshotPathError(screenshotPath, forbiddenCharsList) {
						        ...
						        var _this57 = _possibleConstructorReturn(this, _TestRunErrorBase39.call(this, _types.TEST_RUN_ERRORS.forbiddenCharactersInScreenshotPathError));

						        _this57.screenshotPath = screenshotPath;
						        _this57.forbiddenCharsList = forbiddenCharsList;
						        return _this57;
						    }
						...
						var RoleSwitchInRoleInitializerError = exports.RoleSwitchInRoleInitializerError = function (_TestRunErrorBase40) {
						    _inherits(RoleSwitchInRoleInitializerError, _TestRunErrorBase40);

						    function RoleSwitchInRoleInitializerError(callsite) {
						        _classCallCheck(this, RoleSwitchInRoleInitializerError);

						        var _this58 = _possibleConstructorReturn(this, _TestRunErrorBase40.call(this, _types.TEST_RUN_ERRORS.roleSwitchInRoleInitializerError));

						        _this58.callsite = callsite;
						        return _this58;
						    }
						...
						var ActionElementNotIframeError = exports.ActionElementNotIframeError = function (_TestRunErrorBase41) {
						    _inherits(ActionElementNotIframeError, _TestRunErrorBase41);

						    function ActionElementNotIframeError() {
						        _classCallCheck(this, ActionElementNotIframeError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase41.call(this, _types.TEST_RUN_ERRORS.actionElementNotIframeError));
						    }

						    return ActionElementNotIframeError;
						}(TestRunErrorBase);

						var ActionIframeIsNotLoadedError = exports.ActionIframeIsNotLoadedError = function (_TestRunErrorBase42) {
						    _inherits(ActionIframeIsNotLoadedError, _TestRunErrorBase42);

						    function ActionIframeIsNotLoadedError() {
						        _classCallCheck(this, ActionIframeIsNotLoadedError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase42.call(this, _types.TEST_RUN_ERRORS.actionIframeIsNotLoadedError));
						    }

						    return ActionIframeIsNotLoadedError;
						}(TestRunErrorBase);

						var CurrentIframeIsNotLoadedError = exports.CurrentIframeIsNotLoadedError = function (_TestRunErrorBase43) {
						    _inherits(CurrentIframeIsNotLoadedError, _TestRunErrorBase43);

						    function CurrentIframeIsNotLoadedError() {
						        _classCallCheck(this, CurrentIframeIsNotLoadedError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase43.call(this, _types.TEST_RUN_ERRORS.currentIframeIsNotLoadedError));
						    }

						    return CurrentIframeIsNotLoadedError;
						}(TestRunErrorBase);

						var ChildWindowNotFoundError = exports.ChildWindowNotFoundError = function (_TestRunErrorBase44) {
						    _inherits(ChildWindowNotFoundError, _TestRunErrorBase44);

						    function ChildWindowNotFoundError() {
						        _classCallCheck(this, ChildWindowNotFoundError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase44.call(this, _types.TEST_RUN_ERRORS.childWindowNotFoundError));
						    }

						    return ChildWindowNotFoundError;
						}(TestRunErrorBase);

						var ChildWindowIsNotLoadedError = exports.ChildWindowIsNotLoadedError = function (_TestRunErrorBase45) {
						    _inherits(ChildWindowIsNotLoadedError, _TestRunErrorBase45);

						    function ChildWindowIsNotLoadedError() {
						        _classCallCheck(this, ChildWindowIsNotLoadedError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase45.call(this, _types.TEST_RUN_ERRORS.childWindowIsNotLoadedError));
						    }

						    return ChildWindowIsNotLoadedError;
						}(TestRunErrorBase);

						var CannotSwitchToWindowError = exports.CannotSwitchToWindowError = function (_TestRunErrorBase46) {
						    _inherits(CannotSwitchToWindowError, _TestRunErrorBase46);

						    function CannotSwitchToWindowError() {
						        _classCallCheck(this, CannotSwitchToWindowError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase46.call(this, _types.TEST_RUN_ERRORS.cannotSwitchToWindowError));
						    }

						    return CannotSwitchToWindowError;
						}(TestRunErrorBase);

						var CloseChildWindowError = exports.CloseChildWindowError = function (_TestRunErrorBase47) {
						    _inherits(CloseChildWindowError, _TestRunErrorBase47);

						    function CloseChildWindowError() {
						        _classCallCheck(this, CloseChildWindowError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase47.call(this, _types.TEST_RUN_ERRORS.closeChildWindowError));
						    }

						    return CloseChildWindowError;
						}(TestRunErrorBase);

						var CurrentIframeNotFoundError = exports.CurrentIframeNotFoundError = function (_TestRunErrorBase48) {
						    _inherits(CurrentIframeNotFoundError, _TestRunErrorBase48);

						    function CurrentIframeNotFoundError() {
						        _classCallCheck(this, CurrentIframeNotFoundError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase48.call(this, _types.TEST_RUN_ERRORS.currentIframeNotFoundError));
						    }

						    return CurrentIframeNotFoundError;
						}(TestRunErrorBase);

						var CurrentIframeIsInvisibleError = exports.CurrentIframeIsInvisibleError = function (_TestRunErrorBase49) {
						    _inherits(CurrentIframeIsInvisibleError, _TestRunErrorBase49);

						    function CurrentIframeIsInvisibleError() {
						        _classCallCheck(this, CurrentIframeIsInvisibleError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase49.call(this, _types.TEST_RUN_ERRORS.currentIframeIsInvisibleError));
						    }
						...
						var NativeDialogNotHandledError = exports.NativeDialogNotHandledError = function (_TestRunErrorBase50) {
						    _inherits(NativeDialogNotHandledError, _TestRunErrorBase50);

						    function NativeDialogNotHandledError(dialogType, url) {
						        _classCallCheck(this, NativeDialogNotHandledError);

						        var _this68 = _possibleConstructorReturn(this, _TestRunErrorBase50.call(this, _types.TEST_RUN_ERRORS.nativeDialogNotHandledError));

						        _this68.dialogType = dialogType;
						        _this68.pageUrl = url;
						        return _this68;
						    }
						...
						var UncaughtErrorInNativeDialogHandler = exports.UncaughtErrorInNativeDialogHandler = function (_TestRunErrorBase51) {
						    _inherits(UncaughtErrorInNativeDialogHandler, _TestRunErrorBase51);

						    function UncaughtErrorInNativeDialogHandler(dialogType, errMsg, url) {
						        _classCallCheck(this, UncaughtErrorInNativeDialogHandler);

						        var _this69 = _possibleConstructorReturn(this, _TestRunErrorBase51.call(this, _types.TEST_RUN_ERRORS.uncaughtErrorInNativeDialogHandler));

						        _this69.dialogType = dialogType;
						        _this69.errMsg = errMsg;
						        _this69.pageUrl = url;
						        return _this69;
						    }
						...
						var SetNativeDialogHandlerCodeWrongTypeError = exports.SetNativeDialogHandlerCodeWrongTypeError = function (_TestRunErrorBase52) {
						    _inherits(SetNativeDialogHandlerCodeWrongTypeError, _TestRunErrorBase52);
						    ...
						    function SetNativeDialogHandlerCodeWrongTypeError(actualType) {
						        ...
						        var _this70 = _possibleConstructorReturn(this, _TestRunErrorBase52.call(this, _types.TEST_RUN_ERRORS.setNativeDialogHandlerCodeWrongTypeError));

						        _this70.actualType = actualType;
						        return _this70;
						    }
						...
						var RequestHookUnhandledError = exports.RequestHookUnhandledError = function (_TestRunErrorBase53) {
						    _inherits(RequestHookUnhandledError, _TestRunErrorBase53);

						    function RequestHookUnhandledError(err, hookClassName, methodName) {
						        _classCallCheck(this, RequestHookUnhandledError);

						        var _this71 = _possibleConstructorReturn(this, _TestRunErrorBase53.call(this, _types.TEST_RUN_ERRORS.requestHookUnhandledError));

						        _this71.errMsg = String(err);
						        _this71.hookClassName = hookClassName;
						        _this71.methodName = methodName;
						        return _this71;
						    }
						...
						var RequestHookNotImplementedMethodError = exports.RequestHookNotImplementedMethodError = function (_TestRunErrorBase54) {
						    _inherits(RequestHookNotImplementedMethodError, _TestRunErrorBase54);
						    ...
						    function RequestHookNotImplementedMethodError(methodName, hookClassName) {
						        ...
						        var _this72 = _possibleConstructorReturn(this, _TestRunErrorBase54.call(this, _types.TEST_RUN_ERRORS.requestHookNotImplementedError));

						        _this72.methodName = methodName;
						        _this72.hookClassName = hookClassName;
						        return _this72;
						    }
			...
			"test-run": {
				"browser-console-messages.js": function (exports, module, require) {
					...
					var BrowserConsoleMessages = function () {
					    ...
					    BrowserConsoleMessages.prototype.ensureMessageContainer = function ensureMessageContainer(windowId) {
					    ...
					    BrowserConsoleMessages.prototype.concat = function concat(consoleMessages) {
					        ...
					        if (!consoleMessages) return this;
					    ...
					    BrowserConsoleMessages.prototype.addMessage = function addMessage(type, msg, windowId) {
					    ...
					    BrowserConsoleMessages.prototype.getCopy = function getCopy() {
					        ...
					        Object.keys(this).forEach(function (windowId) {
					            copy[windowId] = {
					                log: _this2[windowId].log.slice(),
					                info: _this2[windowId].info.slice(),
					                warn: _this2[windowId].warn.slice(),
					                error: _this2[windowId].error.slice()
					            };
					        });
				...
				"commands": {
					...
					"utils.js": function (exports, module, require) {
						...
						function isServiceCommand(command) {
						    return command.type === _type2.default.testDone || command.type === _type2.default.showAssertionRetriesStatus || command.type === _type2.default.hideAssertionRetriesStatus || command.type === _type2.default.setBreakpoint || command.type === _type2.default.takeScreenshotOnFail || command.type === _type2.default.recorder;
						}
						...
						function isExecutableOnClientCommand(command) {
						    return command.type !== _type2.default.wait && command.type !== _type2.default.setPageLoadTimeout && command.type !== _type2.default.debug && command.type !== _type2.default.useRole && command.type !== _type2.default.assertion && command.type !== _type2.default.executeExpression && command.type !== _type2.default.executeAsyncExpression;
						}
					},
					"validations": {
			...
			"utils": {
				...
				"browser-connection-timeouts.js": function (exports, module, require) {
					...
					var CHECK_CHILD_WINDOW_DRIVER_LINK_DELAY = exports.CHECK_CHILD_WINDOW_DRIVER_LINK_DELAY = 500;
...
})("testcafe/src/client/driver/index");
