						...
						"index.js": function (exports, module, require) {
							...
							var StatusBar = function (_serviceUtils$EventEm) {
							    ...
							    function StatusBar(userAgent, fixtureName, testName, contextStorage) {
							        ...
							        _this.windowHeight = document.documentElement ? styleUtils.getHeight(window) : window.innerHeight;
							    ...
							    StatusBar.prototype._createIconArea = function _createIconArea() {
							        this.icon = document.createElement('div');
							        shadowUI.addClass(this.icon, ICON_CLASS);
							        this.statusBar.appendChild(this.icon);
							    };

							    StatusBar.prototype._createInformationArea = function _createInformationArea() {
							    ...
							    StatusBar.prototype._createActionsArea = function _createActionsArea() {
							        var _this2 = this;
							        ...
							        this._bindClickOnce([this.unlockButton], function () {
							            shadowUI.removeClass(_this2.unlockButton, LOCKED_BUTTON_CLASS);
							            shadowUI.addClass(_this2.unlockButton, UNLOCKED_BUTTON_CLASS);
							            nativeMethods.nodeTextContentSetter.call(_this2.unlockButton.querySelector('span'), PAGE_UNLOCKED_TEXT);
							    ...
							    StatusBar.prototype._create = function _create() {
							        ...
							        this.progressBar = new _progressBar2.default(this.infoContainer);
							    ...
							    StatusBar.prototype._bindHandlers = function _bindHandlers() {
							        ...
							        listeners.addInternalEventListener(window, ['resize'], function () {
							            _this5.windowHeight = window.innerHeight;
							        });

							        var statusBarHeight = styleUtils.getHeight(this.statusBar);

							        listeners.addFirstInternalHandler(window, ['mousemove', 'mouseout', 'touchmove'], function (e) {
							            if (e.type === 'mouseout' && !e.relatedTarget) _this5._fadeIn(e);else if (e.type === 'mousemove' || e.type === 'touchmove') {
							    ...
							    StatusBar.prototype._getFullStatusText = function _getFullStatusText(statusText) {
							    ...
							    StatusBar.prototype._showDebuggingStatus = function _showDebuggingStatus(isTestError) {
							        ...
							        return new Promise(function (resolve) {
							            ...
							            _this9.state.locked = true;

							            if (isTestError) {
							                _this9.buttons.removeChild(_this9.nextButton);
							                _this9.buttons.removeChild(_this9.resumeButton);
							                _this9.buttons.appendChild(_this9.finishButton);

							                nativeMethods.nodeTextContentSetter.call(_this9.statusDiv, _this9._getFullStatusText(TEST_FAILED_TEXT));
							                shadowUI.removeClass(_this9.statusBar, WAITING_SUCCESS_CLASS);
							                shadowUI.addClass(_this9.statusBar, WAITING_FAILED_CLASS);
							            } else nativeMethods.nodeTextContentSetter.call(_this9.statusDiv, _this9._getFullStatusText(DEBUGGING_TEXT));

							            _this9.actionsContainer.style.display = '';
							            _this9.unlockButton.style.display = '';

							            _this9._bindClickOnce([_this9.resumeButton, _this9.nextButton, _this9.finishButton], function (e) {
							                var isNextButton = domUtils.containsElement(_this9.nextButton, e.target);
							    ...
							    StatusBar.prototype.setStatusPrefix = function setStatusPrefix(prefixText) {
					...
					"ui-root.js": function (exports, module, require) {
						...
						exports.default = {
						    ...
						    remove: function remove() {
						        ...
						        var parent = _hammerhead.nativeMethods.nodeParentNodeGetter.call(shadowRoot);
