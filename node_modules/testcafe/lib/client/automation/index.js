			...
			"client": {
				"automation": {
					...
					"playback": {
						...
						"last-hovered-element-holder.js": function (exports, module, require) {
						...
						"move": {
							...
							"index.js": function (exports, module, require) {
								...
								var _lastHoveredElementHolder = require('../last-hovered-element-holder');

								var _lastHoveredElementHolder2 = _interopRequireDefault(_lastHoveredElementHolder);
								...
								var MoveAutomation = function () {
								    ...
								    MoveAutomation.onMoveOutRequest = function onMoveOutRequest(e) {
								        ...
								        if (!e.message.iframeUnderCursor) {
								            ...
								            var element = _lastHoveredElementHolder2.default.get();

								            if (element) {
								                eventSimulator.mouseout(element, { clientX: clientX, clientY: clientY, relatedTarget: null });
								                eventSimulator.mouseleave(element, { clientX: clientX, clientY: clientY, relatedTarget: null });
								            }
								    ...
								    MoveAutomation.prototype._emulateEvents = function _emulateEvents(currentElement) {
								        ...
								        var _eventSequence$run = eventSequence.run(currentElement, _lastHoveredElementHolder2.default.get(), eventOptions, this.dragElement, this.dragAndDropState.dataStore),
								        ...
								        _lastHoveredElementHolder2.default.set(currentElement);
								    };
						...
						"scroll.js": function (exports, module, require) {
							...
							var ScrollAutomation = function () {
							    ...
							    ScrollAutomation.prototype._setScroll = function _setScroll(element, _ref) {
							        ...
							        var scrollPromise = _testcafeCore.scrollController.waitForScroll(scrollElement);
							    ...
							    ScrollAutomation.prototype._scrollParents = function _scrollParents() {
							        ...
							        var scrollParentsPromise = _testcafeCore.promiseUtils.times(parents.length, function (i) {
							            return _this2._scrollToChild(parents[i], currentChild, { x: currentOffsetX, y: currentOffsetY }).then(function () {
							        ...
							        return scrollParentsPromise.then(function () {
							            if (window.top !== window && !_this2.skipParentFrames) {
							                return (0, _testcafeCore.sendRequestToFrame)({
							                    cmd: SCROLL_REQUEST_CMD,
							                    offsetX: currentOffsetX,
							                    offsetY: currentOffsetY,
							                    maxScrollMargin: _this2.maxScrollMargin
							    ...
							    ScrollAutomation.prototype.run = function run() {
							        ...
							        return this._scrollElement().then(function () {
							            return _this3._scrollParents();
							        }).then(function () {
							            return _this3.scrollWasPerformed;
							        });
							    };
						...
						"type": {
							...
							"type-text.js": function (exports, module, require) {
								...
								function simulateBeforeInput(element, text, needSimulate) {
								    if (needSimulate) return eventSimulator.beforeInput(element, text);
								...
								function _typeTextToContentEditable(element, text) {
								    ...
								    if (!simulateBeforeInput(element, text, browserUtils.isChrome)) return;

								    beforeContentChanged();

								    if (needProcessInput) needProcessInput = simulateBeforeInput(element, text, browserUtils.isSafari);
						...
						"visible-element-automation.js": function (exports, module, require) {
							...
							var _eventBehaviors = require('./move/event-sequence/event-behaviors');
							...
							var VisibleElementAutomation = function (_serviceUtils$EventEm) {
							    ...
							    VisibleElementAutomation.prototype._scrollToElement = function _scrollToElement() {
							        ...
							        var scrollOptions = new _options2.ScrollOptions(this.options);
							        var scrollAutomation = new _scroll2.default(this.element, scrollOptions);
							        var wasScrolled = false;

							        return scrollAutomation.run().then(function (scrollWasPerformed) {
							            wasScrolled = scrollWasPerformed;

							            return (0, _testcafeCore.delay)(_this3.automationSettings.mouseActionStepDelay);
							        }).then(_getElement.underCursor).then(function (currentElement) {
							            var elementUnderCursorContainsTarget = !!currentElement && _this3.element.contains(currentElement);

							            if (!elementUnderCursorContainsTarget || !wasScrolled) return null;

							            var prevElement = _lastHoveredElementHolder2.default.get();
							            var commonAncestor = _testcafeCore.domUtils.getCommonAncestor(currentElement, prevElement);
							            var clientPosition = _testcafeCore.positionUtils.getClientPosition(currentElement);
							            var devicePoint = (0, _getDevicePoint2.default)({ x: clientPosition.x, y: clientPosition.y });
							            var options = {
							                ...
							                shift: false,
							                meta: false,
							                buttons: _testcafeCore.eventUtils.BUTTONS_PARAMETER.leftButton
							            };
...
})("testcafe/src/client/automation/index");
